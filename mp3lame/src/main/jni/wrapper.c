...
void Java_com_github_marcodama7_mp3lame_Mp3LameManager_initEncoder(JNIEnv *env,
...
void Java_com_github_marcodama7_mp3lame_Mp3LameManager_destroyEncoder(
		JNIEnv *env, jobject jobj) {
	int res = lame_close(lame);
	LOGD("Deinit returned: %d", res);
}

void Java_com_github_marcodama7_mp3lame_Mp3LameManager_encodeFile(JNIEnv *env,
